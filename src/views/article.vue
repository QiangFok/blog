  ...
  <article>
    <div class="panel panel-default">
      <div class="panel-body">
        <h1 class="article-title">中文网页重设与排版：Typo.css</h1>
        <div class="article-info">
          ...
          <p>
            ...
            发布时间：2021-01-13 22:11:54
          </p>
        </div>
        <div class="article-main typo typo-seclection js-toc-content">
          ...
          <ul>
            <li>If you wish to succeed, you should use persistence as your good friend, experience as your reference,
              prudence as
            ...
            <li>Only those who have the patience to do simple things perfectly ever acquire the skill to do difficult
              things
              easily.
          ...
          <p><abbr title="法国作家罗切福考尔德">La Racheforcauld</abbr> said:
            <mark>"Few things are impossible in themselves; and it is often for want of will, rather than of means, that
              man fails
              to succeed".
            </mark>
            You just need to follow the browser's behavior, and set a right <code>margin</code> to it。it will works nice
            as the
    ...
    <div class="panel panel-default">
      <div class="panel-body comment">
        <form action="" method="post" role="form">
          <div class="user-img">
            <a href=""><img src="/static/user.jpg" alt=""></a>
          </div>
          <textarea type="" class="form-control" placeholder="输入评论：" maxlength="1000"></textarea>
          <div class="submit">
        ...
        <ul class="list-group">
          <li class="list-group-item">
            ...
            <p>
              <span>flystarfly:</span>
              <span>在Linux部署Dubbo监控中心monitor,你看看你的题目和内容行不行。</span>
              <span class="date">1 月前</span>
              <span>
                <a href="">回复</a>
              </span>
            </p>
    ...
    data() {
      return {
        coms: [
          {
            tag: 'java',
            title: 'java解析调用webservice服务返回的soap XML',
            desc: '对于中间操作和终端操作的定义，请看《JAVA8 stream接口 中间操作和终端操作》，这篇主要讲述的是stream的count，anyMatch，allMatch，noneMatch操作，我们先看下函数的定义',
            date: new Date(),
            count: 100
          },
          {
...
<style scoped>
  ...
  @import "../assets/prism/css/prism.css";
  ...
  .list-group-item p span:first-child {
    margin-right: 14px;
  }

  .list-group-item p span.date {
    font-size: 12px;
    color: #787977;
  }
